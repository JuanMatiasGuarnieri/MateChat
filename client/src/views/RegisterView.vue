  ...
  <div class="min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
      <div class="text-center mb-8">
        ...
        <p class="text-gray-400">Únete a la conversación</p>
      </div>

      <form @submit.prevent="handleRegister" class="bg-gray-800 rounded-xl p-6 shadow-lg">
        ...
        <p class="mt-4 text-center text-gray-400 text-sm">
          ¿Ya tienes cuenta?
          <router-link to="/login" class="text-mate-500 hover:text-mate-400">
            Inicia sesión
          </router-link>
        </p>
      </form>
